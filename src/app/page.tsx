  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
              ...
              {/* Columna derecha — Callout */}
              <motion.div
                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                className="flex items-center gap-3 px-4 py-4 rounded-xl bg-violet-500/10 border border-violet-500/30 backdrop-blur-sm"
              >
                <div className="shrink-0 flex items-center justify-center w-10 h-10 rounded-lg bg-violet-500/20">
                  <SlidersHorizontal className="h-5 w-5 text-violet-400" />
                </div>
                <div className="min-w-0">
                  <p className="text-violet-200 text-xs font-semibold tracking-wide uppercase">
                    Preselección por jurados
                  </p>
                  <p className="text-zinc-300 text-sm leading-snug">
                    Distribuye las películas entre los 5 jurados de forma colaborativa.
                  </p>
                </div>
                <Link
                  href="/programacion"
                  className="shrink-0 ml-auto px-4 py-2 rounded-lg bg-violet-500/20 hover:bg-violet-500/30 border border-violet-500/30 text-violet-200 text-xs font-medium transition-colors whitespace-nowrap"
                >
                  Ir a jurados
                </Link>
              </motion.div>
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Search + Filters bar */}
        <div id="filtros" className="flex flex-col sm:flex-row gap-3 mb-5">
