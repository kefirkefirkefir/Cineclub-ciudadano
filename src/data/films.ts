...
export const films: Film[] = [
  ...
  {
    id: 48, titulo: "Un asunto de familia", direccion: "Hirokazu Kore-eda", pais: "Japón", disponibilidad: "DVD", directora: false, tComunitaria: true, cineNoUSA: true, doblada: true, hispanohablante: false,
    genero: "Drama / Crimen",
